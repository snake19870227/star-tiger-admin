package com.snake19870227.stiger.admin.oauth2.authserver;
...
public class DefaultDbClientDetailsService implements ClientDetailsService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DefaultDbClientDetailsService.class);

    private final SysClientService sysClientService;

    public DefaultDbClientDetailsService(SysClientService sysClientService) {
